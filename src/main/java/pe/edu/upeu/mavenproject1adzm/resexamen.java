...
import pe.edu.upeu.mavenproject1adzm.leerteclado;
...
public class resexamen {
    ...
    public void ejercicio2 (){
        ...
        totaldeautos=lc.leer(0,"por favor ingrese el numero de autos");
        for(int n=1; n<=totaldeautos; n++){
            System.out.println("n° del auto "+n+" ");
            cat=lc.leer(0,"Ingrese el Número de categoria (1,2,3): ");
            preciodeautocat=lc.leer(0.0, "por favor ingrese el precio del auto: ");
            switch(cat){
                case 1:
        ...
        System.out.print("La tabla de multiplicar del 1 al 20: ");
        for(i = 1; i<=num; i++){
            System.out.println("Esta es la tabla de: "+i+"");
            System.out.println();
            //prseso
            for(j = 1; j <=10; j++)
    ...
    public void ejercicio4(){
        int n=1, m=1,num;
        int acum=0;
        num=lc.leer(0, "Por favor Ingrese un número: ");
        //proceso
        while(m<=num){
            while (n<=m/2){
                if(m%n == 0){
